                ...
                <div class="product-card-item">
                    <div class="pmd-card pmd-card-default pmd-z-depth">
                        ...
                        <div class="pmd-card-body">
                            ...
                            <a class="btn btn-outline-primary active btn-block" role="button" data-toggle="modal" data-target="#ITEMID" id="view" style="background-color:#424949;color:#FBFCFC;font-size:15px;" data-toggle="modal" data-target="#modalone"><strong>VIEW</strong></a>
                        </div>
                    </div>
                </div>
            </div>

            <div class="modal fade" id="ITEMID" role="dialog">
